...
def test_checkout():
    ...
    assert checkout("NNNNMM") == 160  # 3N get one M free, 1N, 1M
    assert checkout("RRRRRQQ") == 250  # 3R get one Q free, 2R, 1Q
    ...
    assert checkout("ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZ") == 1880  # Two of each item
